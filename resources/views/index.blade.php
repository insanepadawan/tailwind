...
@section('content')
    ...
    <section id="cta" class="bg-brightRed">
        ...
        justify-between px-6 py-24 mx-auto space-y-12 md:py-12 md:flex-row md:space-y-0">
            <!-- Heading -->
            <h2 class="text-5xl font-bold leading-tight
            text-center-text-white md:text-4xl md:max-w-xl md:text-left">
                Simplify how your team works today
            </h2>
            <!-- Button -->
            <div>
                <a href="#"
                   class="p-3 px-6 pt-2 text-brightRed bg-white rounded-full shadow-2xl
                    baseline hover:bg-gray-900">
                    Get Started
                </a>
            </div>
        </div>
    ...
    <footer class="bg-veryDarkBlue">
        ...
        justify-between px-6 py-10 mx-auto space-y-8
        md:flex-row md:space-y-0">
            <!-- Logo and social links container -->
            <div class="flex flex-col-reverse items-center
            justify-between space-y-12 md:flex-col
            md:space-y-0 md:items-start">
                ...
                <!-- Logo -->
                <div>
                    <img src="{{ url('/i/logo-white.svg') }}" class="h-8" alt="Logo" />
                </div>
                <!-- Social Links Container -->
                <div class="flex justify-center space-x-4">
                    <!-- link 1 -->
                    <a href="#">
                        <img src="{{ url('/i/icon-facebook.svg') }}" alt="icon" class="h-8" />
                    </a>
                    <!-- link 2 -->
                    <a href="#">
                        <img src="{{ url('/i/icon-youtube.svg') }}" alt="icon" class="h-8" />
                    </a>
                    <!-- link 3 -->
                    <a href="#">
                        <img src="{{ url('/i/icon-twitter.svg') }}" alt="icon" class="h-8" />
                    </a>
                    <!-- link 4 -->
                    <a href="#">
                        <img src="{{ url('/i/icon-pinterest.svg') }}" alt="icon" class="h-8" />
                    </a>
                    <!-- link 5 -->
                    <a href="#">
                        <img src="{{ url('/i/icon-instagram.svg') }}" alt="icon" class="h-8" />
                    </a>
                </div>
            </div>
            ...
            <div class="flex flex-col justify-between">
                <form>
                    ...
                    <div class="flex space-x-3">
                        <input type="text" class="flex-1 px-4
                    rounded-full focus:outline-none" placeholder="Updates in your inbox" />
                        <button class="px-6 py-2 text-white
                        rounded-full bg-brightRed
